...
import { Button, Card, Slider, Form, Tag, DatePicker } from "antd";
...
export default function ElectionFilter({ onFilterSubmit }) {
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Form.Item name="Name">
                    <FormInput
                      name="name"
                      placeholder="By Election Name"
                      required={false}
                    />
                  </Form.Item>
                  <Form.Item name="Election Type">
                    <FormInput
                      name="electionType"
