...
export default function ExcelUpload() {
  ...
  const simulateUpload = (file) => {
    ...
    setTimeout(() => {
      ...
      setLastUploadedFile(file.name); // Set this as the last uploaded file
  ...
  return (
    <div className="single-excel-upload-content mt-[30px]">
      ...
      <Form form={form} layout="vertical">
        <div className="content pt-[20px] bg-[#EEEEEE63] p-[5px]">
          <Form.Item>
            <div
              {...getRootProps()}
          ...
          {progressFile && (
            <div className="mb-4 max-w-[445px]">
              <Progress
          ...
          {files.map((file, index) => (
            <div
              key={index}
              className="bg-white border border-green-500 rounded-md mb-5 max-w-[445px] upload-file"
            >
              <div className="flex items-center justify-between p-[9px] mt-[40px]">
