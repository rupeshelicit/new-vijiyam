...
"
                ...
                <div className="w-full flex gap-5 p-[10px]">
                  <div className="w-[62%] relative [box-shadow:0px_2px_8px_0px_#00000022] p-[20px] rounded-[8px]">
                    <div
                      className="See All absolute top-[30px] right-[20px]
"
                    >
                      <Button
                        type="primary"
                        htmlType="submit"
                        className="sigin-btn text-[18px] font-[500] h-[30px] bg-[#54408C] mb-[16px] px-[20px] py-[3px]  "
                      ...
                      >
                        <span className="text-[12px] font-medium">See All</span>
                      </Button>
                    </div>
                    <TableComponent
                      ...
                      additionalComponents={[
                        {
                          ...
                          props: {
                            ...
                            isOn: false,
                            onToggle: () => console.log("Dark mode toggled!"),
                          },
                        },
                      ]}
                    />
