...
import { WhatsappMessageContainer } from "styles/pages/ClientAdmin/SendMessages";
            ...
            <div className="genrate-slip-setting  w-full ">
              ...
              >
                <Form.Item label="Campaign Name">
                  <FormInput placeholder="" name="campaignName" />
                </Form.Item>
                <div className="upload-text flex justify-around items-center gap-[105px] ">
                  <Form.Item
                    name="description"
                    rules={[
                      {
                    ...
                    className="mb-10 max-width: 490px;"
                    label="Description"
                  >
                    <div>
                      <Input.TextArea
